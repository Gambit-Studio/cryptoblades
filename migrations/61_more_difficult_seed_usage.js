...
module.exports = async function (deployer, network, accounts) {
  ...
  if (network === 'bsctestnet' || network === 'bsctestnet-fork' || network === 'bsctestnet_alpha' || network === 'bscmainnet' || network === 'bscmainnet-fork' || network === 'hecotestnet' || network === 'hecomainnet' || network === 'okexmainnet' || network === 'okextestnet') {
