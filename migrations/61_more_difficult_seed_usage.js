...
module.exports = async function (deployer, network, accounts) {
  ...
  if (network === 'bsctestnet' || network === 'bsctestnet-fork' || network === 'bscmainnet' || network === 'bscmainnet-fork' || network === 'bsctestnet_alpha') {
    let openZeppelinRelayerAddress, linkToken, vrfCoordinator, keyHash, fee;
    if (network === 'bsctestnet' || network === 'bsctestnet-fork' || network === 'bsctestnet_alpha') {
