...
module.exports = async function (deployer, network) {
  ...
  else if (network === 'bsctestnet' || network === 'bsctestnet-fork' || network === 'bsctestnet_alpha' || network === 'bscmainnet' || network === 'bscmainnet-fork'  || network === 'hecotestnet' || network === 'hecomainnet' || network === 'okexmainnet' || network === 'okextestnet') {
    let openZeppelinRelayerAddress, linkToken, vrfCoordinator, keyHash, fee;
    if (network === 'bsctestnet' || network === 'bsctestnet-fork' || network === 'bsctestnet_alpha' || network === 'hecotestnet' || network === 'okextestnet') {
